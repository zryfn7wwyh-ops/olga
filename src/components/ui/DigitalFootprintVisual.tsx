...
// Расположены по кругу радиуса 47.5 от центра 50,50 (как цифры на циферблате часов) —
// это радиус нарисованной окружности (42) плюс радиус самой иконки-кружка, чтобы
// иконки касались пунктирной линии, а не рассекали её пополам.
const POSITIONS = [
  { x: 50, y: 2.5 },
  { x: 83.6, y: 16.4 },
  { x: 97.5, y: 50 },
